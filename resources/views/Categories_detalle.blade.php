            ...
            <div class="row g-0">
                <div class="col-md-8">
                    <div class="card-body info-container">
                        ...
                        <p class="card-text"><strong>Id of Category:</strong> {{ $categories->id_category }}</p>
                    </div>
                </div>
            </div>
        </div>
        
        <a href="{{ route('categories') }}" class="btn btn-regresar">Regresar</a>
