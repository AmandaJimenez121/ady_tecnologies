...
<nav class="navbar navbar-dark bg-dark fixed-top">
    ...
    <div class="container">
            ...
            <div class="row g-0">
                <div class="col-md-8">
                    <div class="card-body info-container">
                        ...
                        <p class="card-text"><strong>Id of Product:</strong> {{ $products->id_product }}</p>
                        <p class="card-text"><strong>Description:</strong> {{ $products->description }}</p>
                        <p class="card-text"><strong>Price:$</strong> {{ $products->price }}</p>
                        <p class="card-text"><strong>Stock:</strong> {{ $products->stock }}</p>
        ...
        <a href="{{ route('products') }}" class="btn btn-regresar">Regresar</a>
